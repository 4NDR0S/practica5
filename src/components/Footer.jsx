...
export default function Footer() {
    return (
        <footer className='bg-[#90d4c6] py-16'>
            ...
            <div className='flex w-[297px] place-content-between mx-auto
            ...
            <div className='flex w-[164px] place-content-between mx-auto'>
                <svg className='fill-[#2C7566] hover:fill-white cursor-pointer'
